...
import {AddCheckNotificationModal, ViewCheckNotification, AddCheckTaskModal} from '../../components/inspection/modules/'
...
const {custom: {level}, inspection: {yzj: {notification: notificationDimMap}}} = dimsMap;
        ...
        const _columns = [
             ...
             },*/
            {
                ...
                formatter: ({dependentValues,rowIdx, value, column: {key}})=>{
                    ...
                    return (
                        <span className={cls}>{notificationDimMap['status'][value]}</span>
                    )
                }
                /* events: {
                 onDoubleClick: function () {
        ...
        return (
            <div {...props} className="yzh-check-notification has-no-check-box-all">
                ...
                <Spin
                    ...
                    <ButtonContainer>
                        {/*<AddButton onClick={this.add.bind(this, {type: 'add', data: {}})}>创建查验通知</AddButton>*/}
                        <Button
