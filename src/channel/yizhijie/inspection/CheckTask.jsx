...
import {ViewCheckTask, WriteCheckResultModal} from '../../components/inspection/modules/'
import {authPropTypesWrapper, getArraySelectedInfo, isQueryChanged} from '../../components/helpers/'
import {AuthIdentity, dimsMap} from '../../components/helpers/'
import {fetch, CONFIG} from 'antd/../../src/services/'
const {isSameUser, getUserRole, getUser} = AuthIdentity;
const {custom: {level}, inspection: {yzj: {task: taskDimMap}}} = dimsMap;
...
class CheckTask extends Component{
    ...
    render() {
        ...
        const {selectedIds, selectedRows, spinning, tip,
            ...
            tableLoading, viewCheckTask, writeCheckResultModal, checkPersonnelList} = this.state;
        ...
        const _columns = [
            ...
            },
            {
                ...
                formatter: ({dependentValues,rowIdx, value, column: {key}})=>{
                    ...
                    return (
                        <span className={cls}>{taskDimMap[key][value]}</span>
                    )
                }
                /* events: {
                 onDoubleClick: function () {
