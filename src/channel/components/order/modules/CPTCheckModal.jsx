...
class CPTCheckModal extends Component{
    _retInitialState = ()=>{
        return {
    ...
    cptTransport = (data = {}, callback = ()=>{})=>{
        fetch('ciq.crossorderstep.completeinspectioncheck', {
            // method: 'post',
            // headers: {},
            data: data,
            success: (res)=>{
...
CPTCheckModal.defaultProps = {
    prefix: 'yzh',
    visible: false,
    callback: noop,
};

CPTCheckModal = Form.create()(CPTCheckModal);

export default CPTCheckModal;