...
class CPTInspectionModal extends Component{
    _retInitialState = ()=>{
        return {
    ...
    cptApply = (data = {}, callback = ()=>{})=>{
        fetch('ciq.crossorderstep.completeinspectionapply', {
            // method: 'post',
            // headers: {},
            data: data,
            success: (res)=>{
                ...
                <Form honrizontal>
                    ...
                    <Form.Item
                        ...
                        {getFieldDecorator('billCode', {
                            ...
                            rules: [
                                {required: true, message: '报检单单号为必填项'}
                            ]
                        })(
...
CPTInspectionModal.defaultProps = {
    prefix: 'yzh',
    visible: false,
    callback: noop,
};

CPTInspectionModal = Form.create()(CPTInspectionModal);

export default CPTInspectionModal;