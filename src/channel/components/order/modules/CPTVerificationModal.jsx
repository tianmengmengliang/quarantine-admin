...
class CPTVerificationModal extends Component{
    _retInitialState = ()=>{
        return {
     ...
     * @param {func} 回调函数
     * */
    cptVerification = (data = {}, callback = ()=>{})=>{
        fetch('ciq.crossorderstep.completewriteoff', {
            // method: 'post',
            // headers: {},
            data: data,
            success: (res)=>{
    ...
    onOk = ()=> {
        this.props.form.validateFields((err, values) => {
            ...
            this.cptVerification(values, (err, res)=> {
                // case1. 表单验证不通过
                if(err){
                    // s2-ss1-case1. 提交订单失败
                ...
                <Form honrizontal>
                    ...
                    <Form.Item
                        ...
                        {getFieldDecorator('billCode', {
                            ...
                            rules: [
                                {required: true, message: '核销单单号为必填项'}
                            ]
                        })(
...
CPTVerificationModal.propTypes = {
    data: PropTypes.any,
...
CPTVerificationModal.defaultProps = {
    prefix: 'yzh',
    visible: false,
    callback: noop,
};

CPTVerificationModal = Form.create()(CPTVerificationModal);

export default CPTVerificationModal;