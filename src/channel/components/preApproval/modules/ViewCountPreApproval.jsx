...
class ViewCountPreApproval extends Component{
  _retInitialState = ()=>{
    return {
    ...
    return (
      ...
      >
        <Tabs
          ...
          <Tabs.TabPane tab={<span><Icon type="android"/>评估意见表</span>} key="2">
...
ViewCountPreApproval.propTypes = {
  data: PropTypes.any,
...
ViewCountPreApproval.defaultProps = {
  prefix: 'yzh',
  visible: false,
  callback: noop,
};

ViewCountPreApproval = Form.create()(ViewCountPreApproval);

export default ViewCountPreApproval;
