...
* 现场评估页面
* */
class SiteInAssessC extends Component{
                    ...
                    return (
                        <ButtonContainer>
                            <Button
                                type="primary"
                                icon="contacts"
                                onClick={this.dispatchPreApprovalClick.bind(this, {data: selectedRows})}>分派</Button>
                        </ButtonContainer>
                    )
                },
                /* events: {
...
SiteInAssessC.propTypes = {
    prefix: PropTypes.string,
    rowKey: PropTypes.string
};

SiteInAssessC.defaultProps = {
    prefix: 'yzh',
    rowKey: 'id'
};

SiteInAssessC = Form.create()(SiteInAssessC);
...
export default connect(mapStateToProps)(SiteInAssessC);