...
class SiteUnAssessC extends Component{
...
SiteUnAssessC.propTypes = {
    prefix: PropTypes.string,
    rowKey: PropTypes.string
};

SiteUnAssessC.defaultProps = {
    prefix: 'yzh',
    rowKey: 'id'
};

SiteUnAssessC = Form.create()(SiteUnAssessC);
...
export default connect(mapStateToProps)(SiteUnAssessC);