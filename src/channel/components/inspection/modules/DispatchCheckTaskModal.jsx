...
class DispatchCheckTaskModal extends Component{
     ...
     * @param {object} _props 参数对象
     * */
    dispatchCheckTask = ({data}, callback)=>{
        fetch('ciq.checktask.dispatchtask', {
            // method: 'post',
            // headers: {},
            data: data,
            success: (res)=>{
    ...
    onOk = ()=> {
        this.props.form.validateFieldsAndScroll((err, values) => {
            ...
            this.dispatchCheckTask({data: params}, (err, res)=>{
                if(err){
                    message.error('分派查验任务失败');
                    return;
                }
...
DispatchCheckTaskModal.propTypes = {
    data: PropTypes.any,
...
DispatchCheckTaskModal.defaultProps = {
    prefix: 'yzh',
    rowKey: 'id',
    checkPersons: [],
    visible: false,
...
export default Form.create()(DispatchCheckTaskModal);
