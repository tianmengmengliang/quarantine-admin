...
import {ModalA, BodyGridTable, GridTable, PDFViewer2 } from '../../../../components/'
...
const {custom: {level}, order: {orderType}, tms: {tempType}, inspection: {checkType}, product: {itemTypes, countUnit, weightUnit, valueUnit}, custom: {entryExit}} = dimsMap;
...
class ViewCheckTaskForECIQModal extends Component{
        ...
        const rows = [
            ...
            [
                ...
                },
                {
                    ...
                    formatter: (gridMetaData)=>{
                        return (
                            <span>{data.planTime ? moment(data.planTime).format("YYYY-MM-DD HH:mm:SS") : ''}</span>
                        )
                    }
                },
                {
...
ViewCheckTaskForECIQModal.propTypes = {
    data: PropTypes.any,
...
ViewCheckTaskForECIQModal.defaultProps = {
    prefix: 'yzh',
    visible: false,
    callback: noop,
};

export default Form.create()(ViewCheckTaskForECIQModal);
