...
class ViewCheckResultModal extends Component{
        ...
        return (
            <ModalA
                ...
                <div className={`${prefix}-view-check-result-modal`}>
                    <Alert message="基本信息" type="success" style={{margin:'10px 0 0 0'}}/>
                    <BodyGridTable
                        rows={rows}
                        rowHeight={36}/>
...
ViewCheckResultModal.propTypes = {
    data: PropTypes.any,
...
ViewCheckResultModal.defaultProps = {
    prefix: 'yzh',
    visible: false,
    callback: noop,
};

export default Form.create()(ViewCheckResultModal);
