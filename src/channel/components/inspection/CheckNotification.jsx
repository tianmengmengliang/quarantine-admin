    ...
    * */
    ...
    render() {
        ...
        const {selectedIds, selectedRows, spinning, tip,
            ...
            dispatchCheckTaskModal, addCheckTaskModal} = this.state;
           ...
           /* {
            ...
            },*/
            {
                ...
                formatter: ({dependentValues,rowIdx, value, column: {key}})=>{
                    ...
                    return (
                        <Permission render={({role})=>{
                            return (
                                <span className={cls}>
                                {
                                role &&
                            role.some((useRole)=>{
                                return useRole["nameEn"] === 'ciq_jianyiju'
                            }) ? dimsMap.inspection.ciq['notification']['status'][value] : status[value]
                                }
                                </span>
                            )
                        }}>
            ...
            <div {...props} className="yzh-check-notification has-no-check-box-all">
                ...
                <Spin
                    ...
                    <ButtonContainer>
                        ...
                        <Permission
                            resId={`/cygl/checkNotification/sendNotificationBtn`}
                            resType={`btn`}
                            resRole={"ciq_yunying"}>
                            <Button
                                onClick={this.sendCheckNotificationClick.bind(this, {data: selectedRows})}
                                type="primary"
                                icon="notification">发送通知</Button>
                        </Permission>
                        <Permission
                            resId={`/cygl/checkNotification/editBtn`}
                            resType={`btn`}
                            resRole={"ciq_yunying"}>
