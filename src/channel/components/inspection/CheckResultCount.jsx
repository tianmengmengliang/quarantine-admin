...
class CheckResultCount  extends Component{
    ...
    _retInitialState = ()=>{
        return {
            ...
            buttonloading1: false,                                  // 按钮首先不加载状态。
            sortOrder: 'desc',                                      // 排序降序
        }
    ...
    _getAllListQuery = (pageQuery = {})=>{
        ...
        this.props.form.validateFieldsAndScroll((err, values) => {
           ...
           // _values = values;
           ["userId","eciqCode","writeOffBillCode","orderCode","orgName","createTime","finishTime","status"].map((key)=>{
                if(key === "createTime" ){
    ...
    getCheckResultList = (query)=>{
        ...
        console.log(_q);
        // step2. 请求列表数据
        fetch('ciq.checktask.statisticallist', {
            // method: 'post',
            // headers: {},
            data: _q,
            success: (res)=>{
...
//---------------------------------------------- end -------------------------------------
    ...
    render() {
        ...
        const {selectedIds, selectedRows, spinning, tip,
            ...
            tableLoading, buttonloading1, viewCheckResultModal} = this.state;
                ...
                <Spin
                    ...
                    <ButtonContainer>
                        ...
                        <Button type="primary" icon="file-text" loading={buttonloading1}
                                        onClick={this.excelCheckResultCilck.bind(this,{pageIndex, pageSize})}>导出数据</Button>
...
CheckResultCount.propTypes = {
    prefix: PropTypes.string,
    rowKey: PropTypes.string
};

CheckResultCount.defaultProps = {
    prefix: 'yzh',
    rowKey: 'id'
};

CheckResultCount = Form.create()(CheckResultCount);
...
export default connect(mapStateToProps)(CheckResultCount);
