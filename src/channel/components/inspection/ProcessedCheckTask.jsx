...
import {ViewCheckTaskForECIQModal, WriteCheckResultModal, AddCheckTaskModal} from '../../components/inspection/modules/'
...
class ProcessedCheckTask extends Component{
    ...
    addCheckTaskClick = ({data: selectedRows})=>{
        ...
        if(this._hasSelectedOnlyOneIdx(selectedRows, '请选择一条查验任务')) {
            const isStatusLessEqual2 =  selectedRows[0] && selectedRows[0]['status'] <= 2;
            if(isStatusLessEqual2) {
    ...
    render() {
        ...
        const {selectedIds, selectedRows, spinning, tip,
            ...
            tableLoading, viewCheckTask, writeCheckResultModal, addCheckTaskModal} = this.state;
...
ProcessedCheckTask.propTypes = {
    prefix: PropTypes.string,
    rowKey: PropTypes.string
};

ProcessedCheckTask.defaultProps = {
    prefix: 'yzh',
    rowKey: 'id'
};

ProcessedCheckTask = Form.create()(ProcessedCheckTask);
...
export default connect(mapStateToProps)(ProcessedCheckTask);