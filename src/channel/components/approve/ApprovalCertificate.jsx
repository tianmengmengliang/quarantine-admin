...
import {ApprovalCertQueryForm, UploadCertificateModal} from './modules/'
...
class ApprovalCertificate extends Component{
        ...
        const _columns = [
            ...
            },
            {
                ...
                formatter: (props)=> {
                    return (
                        <span>
                            <a onClick={this.edit.bind(this, props)}>上传证书<span className="ant-divider"/></a>
        ...
        return (
            <div {...props}>
                ...
                <div className="hidden">
                    <UploadCertificateModal visible={false}/>
                </div>
                <ButtonContainer>
                    <AddButton onClick={this.add}>审批单填写</AddButton>
                </ButtonContainer>
                <GridTable
...
ApprovalCertificate = authPropTypesWrapper(ApprovalCertificate);
...
export default connect(mapStateToProps)(ApprovalCertificate);