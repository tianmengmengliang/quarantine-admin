...
import {VerificationCertQueryForm} from './modules/'
...
class VerificationCert extends Component{
    ...
    render() {
        ...
        return (
            <div {...props}>
                <VerificationCertQueryForm />
                <ButtonContainer>
                    <AddButton onClick={this.add}>核销单填写</AddButton>
                </ButtonContainer>
                <GridTable
...
VerificationCert = authPropTypesWrapper(VerificationCert);
...
export default connect(mapStateToProps)(VerificationCert);