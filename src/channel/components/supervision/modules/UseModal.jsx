...
import {GridTable, Block, Inline,
    ...
    DelButton, UploadButton, EditButton, SearchButton, ModalA} from 'antd/../../src/components/'
    ...
    expandedRowRender = (_pRecord, index) => {
                ...
                render: (value, record, i) => {
                    ...
                    return (
                        <ButtonContainer style={{margin: 0}}>
                            {
                                !editable ?
                                    <Permission resId={'/hxjg/use/userLogOperation'}>
                                        <span>
                                    <Button
        ...
        return (
            <Spin
                ...
                {
                    status === 'error' ?
                        <div className="ant-table-placeholder"><span><i className="anticon anticon-frown-o"></i>获取数据失败</span><div style={{fontSize: 16, fontWeight: 500}}><a onClick={this.getUserLogList.bind(this, _pRecord)}>重新获取数据</a></div></div> :
                        <div>
...
export default Form.create()(UseModal);