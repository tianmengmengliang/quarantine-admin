...
class AddReceiptAndSendCargoModal extends Component{
    _retInitialState = ()=>{
        return {
            ...
            <Form
                ...
                <Form.Item
                    ...
                    {getFieldDecorator('packagesCount', {
                        initialValue: isNaN(parseInt(data.packagesCount)) ? undefined : parseInt(data.packagesCount),
                        rules: false
                    })(
                ...
                <Form.Item
                    ...
                    {getFieldDecorator('weight', {
                        initialValue: isNaN(parseFloat(data.weight)) ? undefined : parseFloat(data.weight),
                        rules: false
                    })(
                ...
                <Form.Item
                    ...
                    {getFieldDecorator('grossWeight', {
                        initialValue: isNaN(parseFloat(data.grossWeight)) ? undefined : parseFloat(data.grossWeight),
                        rules: false
                    })(
                        <InputNumber min={0}  style={wrapperColStyle}/>
                    )}
...
AddReceiptAndSendCargoModal.propTypes = {
    data: PropTypes.any,
...
AddReceiptAndSendCargoModal.defaultProps = {
    prefix: 'yzh',
    visible: false,
    callback: noop,
};

AddReceiptAndSendCargoModal = Form.create()(AddReceiptAndSendCargoModal);

export default AddReceiptAndSendCargoModal;